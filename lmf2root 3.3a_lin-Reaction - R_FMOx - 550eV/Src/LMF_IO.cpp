...
/////////////////////////////////////////////////////////////////
{
	...
	*input_lmf >> SIMPLE_DAQ_ID_Orignial;
	unsigned tempi;
	*input_lmf >> tempi; int64_Numberofevents = tempi;
...
//  READ LMF-HEADER
	...
	*input_lmf >> data_format_in_header;
	...
	if (Cobold_Header_version >= 2008) *input_lmf >> int64_Numberofevents;
	if (Cobold_Header_version <= 2002) {
		__int32 temp;
		*input_lmf >> temp;
		int64_Numberofevents = temp;
	}
...
/////////////////////////////////////////////////////////////////
bool LMF_IO::SeekToEventNumber(__int64 target_number)
/////////////////////////////////////////////////////////////////
{
...
*/
	...
	if (target_number > int64_Numberofevents) return false;
	__int32 eventsize;
	...
	int64_number_of_read_events = target_number;
	must_read_first = true;
	errorflag = 0;
	input_lmf->error = 0;
	return true;
...
/////////////////////////////////////////////////////////////////
{
	...
	if (TDC8HP.variable_event_length == 1) {
		...
		if (!TDC8HP.exotic_file_type) {
			...
			*input_lmf >> int64_LMF_EventCounter;
			if (input_lmf->error) {if (input_lmf->eof) this->errorflag = 18; else this->errorflag = 1; return false;}
		} else {
...
/////////////////////////////////////////////////////////////////
{
	return int64_number_of_read_events;
}
...
/////////////////////////////////////////////////////////////////
{
	...
	clone->int64_LMF_EventCounter	= this->int64_LMF_EventCounter;
	clone->int64_number_of_read_events	= this->int64_number_of_read_events;
	clone->int64_Numberofevents	= this->int64_Numberofevents;
