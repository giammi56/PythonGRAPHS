...
public:
	...
	void generate_pos_correction_profiles();	// FUNCTION
...
public:
	...
	void generate_sum_walk_profiles();		// FUNCTION
...
public:
	...
	void   do_auto_calibration(double w_offset);  // FUNCTION
	double get_ratio_of_full_bins();  // FUNCTION
	bool   map_is_full_enough(); // FUNCTION
	void   finalize(); // FUNCTION
...
public:
	...
	double get_random_gauss_value();  // FUNCTION
	double get_random_value();  // FUNCTION
...
public:
	...
	bool write_to_file(void * file);	// FUNCTION
	bool read_from_file(void * file);	// FUNCTION
